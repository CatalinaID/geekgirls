...
1. [Install Jekyll](http://jekyllrb.com) and read through [this installation instructions]({{ site.github.url }}/theme-setup/installing-jekyll-on-windows/) if you haven't already.
...
This theme is free and open source software, distributed under the [The MIT License]({{ site.github.url }}/license/). So feel free to use this Jekyll theme on your site without linking back to me or using a disclaimer.
