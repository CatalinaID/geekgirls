...
<div class="row">
  ...
  <div class="large-7 columns">
    ...
    <div class="row">
      ...
      <strong> <span style="font-size: 175%; line-height: 1;">Then, how to handle crashes on production? How we know the cause of crashes on every user session?</span> </strong>
